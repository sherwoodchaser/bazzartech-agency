...
function HeroSection({ children }) {
  return (
    <section className="relative w-dvw overflow-hidden pt-40 md:pt-54 pb-20 bg-[#0b0b0b] flex items-center justify-center">
      <Spotlight />
      ...
      <div className="relative z-30 md:w-[70%]">{children}</div>
    </section>
  );
}
